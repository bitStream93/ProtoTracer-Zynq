...
#
# Generated by export_simulation on Fri Feb 11 00:05:53 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './MBMC.sh' script.
...
./MBMC.sh -noclean_files

For more information on the script, please type './MBMC.sh -help'.
