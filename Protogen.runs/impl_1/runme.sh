...
HD_PWD='C:/Protogen/Protogen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Protogen_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Protogen_wrapper.tcl -notrace
