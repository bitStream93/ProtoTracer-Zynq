...
HD_PWD='C:/Protogen/Protogen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Protogen_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Protogen_wrapper.tcl
